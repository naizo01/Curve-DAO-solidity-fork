...
### CRV供給量とその分配
CRVトークンの初期供給量は1.3 billion CRVで、最終的な供給量は3.03 billion CRVとされています。この供給量は流動性提供者、チーム・投資家、従業員、コミュニティリザーブに分配されます。流動性提供者には62%が割り当てられており、流動性提供者が受け取るCRVの排出量は年々減少していきます。
